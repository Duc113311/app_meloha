...
const double minBottomNeckRadius = 0;
...
const Offset tooltipTextPadding = Offset(8, 8);
const double tooltipTriangleHeight = 7;
const double tooltipTriangleWidth = 12;
const double minTooltipWidth = 42.0;
const double minTooltipHeight = 35.0;
const double cornerRadius = 18.5;
