...
class Chat extends StatefulWidget {
  ...
  const Chat({
    ...
    this.emojiEnlargementBehavior = EmojiEnlargementBehavior.single,
    this.emptyState,
  ...
  /// List of [Message] to render in the chat widget.
  ...
  final Widget Function(MessageDto)? systemMessageBuilder;
  ...
  /// See [InheritedUser.friend].
  final CustomerDto friend;
...
class ChatState extends State<Chat> {
  ...
  Widget _emptyStateBuilder() =>
      ...
      Container(
        ...
        child: Text(
          S.current.emptyChatPlaceholder,
  ...
  Widget _messageBuilder(
    ...
    if (object is DateHeader) {
      ...
      final message = map['message']! as MessageDto;
      String senderId = message.senderId ?? '';
      bool isAuthor = (senderId == widget.user.id);
      CustomerDto author = isAuthor ? widget.user : widget.friend;

      final Widget messageWidget;
      final messageWidth =
          widget.showUserAvatars && message.senderId != widget.user.id
              ? min(constraints.maxWidth * 0.72, 440).floor()
              : min(constraints.maxWidth * 0.78, 440).floor();

      messageWidget = MessageWG(
        ...
        roundBorder: map['firstMessageInGroup'] == true,
        showAvatar: map['showAvatar'] == true,
        showName: map['showName'] == true,
        showStatus: map['showStatus']! as bool,
        lastMessageInGroup: map['showStatus']! as bool,
        onlyMessageInGroup: map['onlyMessageInGroup'] == true,
  ...
  void _onPreviewDataFetched(
    ...
    widget.onPreviewDataFetched?.call(messageID, previewData);
  }
  ...
  void _refreshAutoScrollMapping() {
    ...
    for (final object in _chatMessages) {
      if (object is UnreadHeaderData) {
        ...
        final message = object['message']! as MessageDto;
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    widget.customBottomWidget ?? _input()
                  ],
                ),
              ),
  ...
  Widget _input() => widget.showInput
      ? Input(
          key: _inputKey,
          isAttachmentUploading: widget.isAttachmentUploading,
          onAttachmentPressed: widget.onAttachmentPressed,
          onSendPressed: widget.onSendPressed,
          onWavePressed: widget.onWavePressed,
