...
abstract class ChatTheme {
  ...
  const ChatTheme({
    ...
    required this.emojiCustomStyle,
  });
  ...
  final TextStyle emojiCustomStyle;
}
...
class DefaultChatTheme extends ChatTheme {
  ...
  const DefaultChatTheme({
    super.emojiTextStyle = const TextStyle(
      color: neutral7,
      fontSize: 25,
    ...
    super.messageInsetsHorizontal = 8,
    ...
    super.emojiCustomStyle = const TextStyle(
      fontSize: 30,
